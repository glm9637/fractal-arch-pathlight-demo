...
*/
        async fn get_todo_list(
            &self,
            request: tonic::Request<super::super::request::GetTodoListRequest>,
        ) -> std::result::Result<
...
*/
        async fn add_todo_entry(
            &self,
            request: tonic::Request<super::super::request::AddTodoEntryRequest>,
        ) -> std::result::Result<
...
*/
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/pathlight.todo.api.v1.service.TodoService/GetTodoList" => {
                    ...
                    struct GetTodoListSvc<T: TodoService>(pub Arc<T>);
                    impl<
                        T: TodoService,
                    > tonic::server::UnaryService<
                        super::super::request::GetTodoListRequest,
                    > for GetTodoListSvc<T> {
                        type Response = super::super::response::GetTodoListResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as TodoService>::get_todo_list(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = GetTodoListSvc(inner);
                ...
                "/pathlight.todo.api.v1.service.TodoService/AddTodoEntry" => {
                    #[allow(non_camel_case_types)]
                    struct AddTodoEntrySvc<T: TodoService>(pub Arc<T>);
                    impl<
                        T: TodoService,
                    > tonic::server::UnaryService<
                        super::super::request::AddTodoEntryRequest,
                    > for AddTodoEntrySvc<T> {
                        type Response = super::super::response::AddTodoEntryResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TodoService>::add_todo_entry(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = AddTodoEntrySvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "pathlight.todo.api.v1.service.TodoService";
